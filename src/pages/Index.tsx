  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="md:w-1/2 section-animate">
              <h1 className="text-3xl md:text-5xl font-bold text-white mb-6">
                Você se sente sobrecarregado(a) emocionalmente e não sabe por onde começar?
              </h1>
              <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed">
                Descubra como a psicoterapia online pode transformar sua rotina com acolhimento real, escuta ativa e estratégias práticas para o seu bem-estar emocional.
                Sinta-se compreendido(a), apoiado(a) e pronto(a) para evoluir no seu tempo.
              </p>
      ...
      <section id="sobre" className="py-20 bg-off-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16 section-animate">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-6">Sobre a Profissional</h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="relative rounded-lg overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end p-6">
                  <div className="text-white">
                    <h3 className="text-2xl font-semibold">Maria Silva</h3>
                    <p className="text-white/80">CRP 01/12345</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:w-2/3 mt-8 md:mt-0 section-animate">
              <p className="text-lg leading-relaxed text-gray-700 mb-6">
                Olá! Sou Maria Silva, formada em Psicologia com foco em terapias comportamentais. 
                Meu trabalho é baseado em acolhimento, dedicação e estratégias reais que fazem sentido na sua vida. 
                Aqui, cada pessoa é única — e meu compromisso é te escutar, orientar e apoiar com todo o cuidado que você merece.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                <div className="bg-white p-4 rounded-lg shadow-md flex items-center gap-3">
                  ...
                  <span className="font-medium">Atendimentos de segunda a sábado</span>
                </div>
      ...
      <section id="diferenciais" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16 section-animate">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-6">Diferenciais</h2>
            <div className="w-24 h-1 bg-burnt-red mx-auto mb-8"></div>
            <p className="text-lg text-gray-700">
              O que torna meu atendimento especial e adequado para suas necessidades
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: (
                  <svg className="w-8 h-8 text-burnt-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                ),
                title: "Sessões 100% online",
                description: "Atendimento de qualidade no conforto do seu lar, economizando tempo e deslocamento."
              },
              {
                icon: (
                  <svg className="w-8 h-8 text-burnt-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                description: "Suporte adicional quando precisar, com chamadas de acolhimento em momentos difíceis."
              },
              {
                icon: (
                  <svg className="w-8 h-8 text-burnt-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                description: "Exercícios e reflexões adaptados ao seu caso, para aplicar no dia a dia e potencializar resultados."
              },
              {
                icon: (
                  <svg className="w-8 h-8 text-burnt-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                description: "Comunicação facilitada para dúvidas pontuais e suporte entre sessões."
              },
              {
                icon: (
                  <svg className="w-8 h-8 text-burnt-red" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                description: "Evolução monitorada com feedbacks constantes e adaptação do processo terapêutico."
              }
            ].map((feature, index) => (
              <div 
                key={index}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M11.998 0C5.379 0 0 5.379 0 12c0 2.657.875 5.11 2.351 7.093L.813 23.584l4.63-1.47c1.891 1.292 4.164 2.047 6.603 2.047C18.618 24.16 24 18.782 24 12.16 24 5.538 18.62.16 11.998.16zm0 22.057c-2.444 0-4.71-.756-6.378-2.047l-.456-.273-4.725 1.505 1.531-4.473-.344-.486C.606 15.345 0 12.828 0 12.16 0 5.538 5.38 0 11.998 0 18.618 0 23.998 5.378 23.998 11.998c0 6.623-5.38 12.202-12 12.202z" fillRule="evenodd" />
                </svg>
              ...
              <a 
                href="https://chat.whatsapp.com/community-link" 
                target="_blank" 
                rel="noopener noreferrer" 
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-white/70">Cuidando da sua saúde mental com carinho e profissionalismo</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/20 text-center text-white/60 text-sm">
            <p>&copy; {new Date().getFullYear()} PsicoAcolhe. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
